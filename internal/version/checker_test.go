...
func TestUpdateCommand(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			contains: []string{"go install", "v1.0.0", "github.com/guyghost/sidecar"},
		},
		{
		...
		},
		{
			...
			contains: []string{"https://github.com/guyghost/sidecar/releases/tag/v1.0.0"},
		},
	}
...
func TestCheck_APIErrors(t *testing.T) {
	tests := []struct {
		...
		},
		{
			...
			body:       `{"tag_name": "v1.0.0", "html_url": "https://github.com/guyghost/sidecar/releases/tag/v1.0.0"}`,
			wantErr:    false,
		},
	}
...
func TestCheckResult(t *testing.T) {
	...
	result := CheckResult{
		...
		UpdateURL:      "https://github.com/guyghost/sidecar/releases/tag/v1.2.0",
		HasUpdate:      true,
		Error:          nil,
	}
...
func TestRelease(t *testing.T) {
	...
	r := Release{
		...
		HTMLURL:     "https://github.com/guyghost/sidecar/releases/tag/v1.0.0",
	}

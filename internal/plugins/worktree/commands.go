...
func (p *Plugin) Commands() []plugin.Command {
	...
	case ViewModeInteractive:
		return []plugin.Command{
			...
			{ID: "copy", Name: "Copy", Description: "Copy selection (" + p.getInteractiveCopyKey() + ")", Context: "worktree-interactive", Priority: 2},
			{ID: "paste", Name: "Paste", Description: "Paste clipboard (" + p.getInteractivePasteKey() + ")", Context: "worktree-interactive", Priority: 3},
		}
	case ViewModeCreate:
		return []plugin.Command{

...
**Binary download:** Grab a pre-built binary from [GitHub Releases](https://github.com/guyghost/sidecar/releases).
...
**Update methods:**
- **Setup script:** `curl -fsSL https://raw.githubusercontent.com/guyghost/sidecar/main/scripts/setup.sh | bash`
- **Homebrew:** `brew upgrade sidecar`
- **Binary:** Download the latest from [GitHub Releases](https://github.com/guyghost/sidecar/releases)
...
- **[GitHub Repository](https://github.com/guyghost/sidecar)** - Source code and issues

**Build from source:**

```bash
git clone https://github.com/guyghost/sidecar.git
cd sidecar
make build
make install
```

Requires Go 1.21+. See the [GitHub README](https://github.com/guyghost/sidecar#development) for development setup.

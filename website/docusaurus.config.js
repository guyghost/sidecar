...
const config = {
  ...
  customFields: {
    githubUrl: 'https://github.com/guyghost/sidecar',
  },
    ...
    [
      ...
      ({
        docs: {
          ...
          editUrl: 'https://github.com/guyghost/sidecar/tree/main/website/',
        },
        blog: {
    ...
    ({
      ...
      navbar: {
        ...
        items: [
          ...
          {
            href: 'https://github.com/guyghost/sidecar',
            label: 'GitHub',
            position: 'right',
          },
        ],
        ...
        links: [
          ...
          },
          {
            ...
            items: [
              ...
              {
                label: 'Issues',
                href: 'https://github.com/guyghost/sidecar/issues',
              },
              {
                label: 'Releases',
                href: 'https://github.com/guyghost/sidecar/releases',
              },
            ],
          },
        ],

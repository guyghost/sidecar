...
const INSTALL_COMMAND = 'curl -fsSL https://raw.githubusercontent.com/guyghost/sidecar/main/scripts/setup.sh | bash';
          ...
          <div className="sc-heroHeader">
            ...
            <div className="sc-heroCta">
              ...
              <div className="sc-heroSecondary">
                ...
                <a className="sc-btnSecondary" href={siteConfig.customFields?.githubUrl || 'https://github.com/guyghost/sidecar'}>
        ...
        <section className="sc-bottomCta">
          <div className="container">
            ...
            <div className="sc-bottomCtaLinks">
              ...
              <a className="sc-btnSecondary" href="https://github.com/guyghost/sidecar">
                <i className="icon-github" /> GitHub
              </a>
            </div>
            ...
            <div className="sc-modal" onClick={(e) => e.stopPropagation()}>
              ...
              <div className="sc-modal-body">
                ...
                <div className="sc-install-method">
                  ...
                  <p className="sc-install-desc">Download pre-built binaries from <a href="https://github.com/guyghost/sidecar/releases">GitHub Releases</a></p>
                </div>
                <div className="sc-install-method">
                  <h4>From Source</h4>
                  <div className="sc-codeBlock sc-installBlock">
                    <div className="sc-installCommand">
                      <span className="sc-lineBlue">$ </span>
                      <span>go install github.com/guyghost/sidecar/cmd/sidecar@latest</span>
                    </div>
                  </div>
                </div>
              </div>

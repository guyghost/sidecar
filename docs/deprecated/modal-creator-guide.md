> DEPRECATED: Superseded by `docs/deprecated/guides/ui-feature-guide.md`. Modal creation must follow `docs/spec-modal-library.md`.
...
2. **For dimmed background modals** (preferred for most cases):
   - Import `github.com/guyghost/sidecar/internal/ui`
